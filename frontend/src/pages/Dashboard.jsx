    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        <FinancialCard
          ...
          label="Total Balance"
          value={`KSh${Math.round(displayIncome - displayExpenses).toLocaleString()}`}
          additionalContent={
            <div className="flex items-center gap-2 mt-2 text-sm">
              <span className={dashboardStyles.balanceBadge}>
                +KSh{Math.round(displayIncome).toLocaleString()}
              </span>
              <span className={dashboardStyles.expenseBadge}>
                -KSh{Math.round(displayExpenses).toLocaleString()}
              </span>
            </div>
          }
        />
        ...
        <FinancialCard
          ...
          value={`KSh${Math.round(displayExpenses).toLocaleString()}`}
          additionalContent={
            <div
        ...
        <FinancialCard
          ...
          value={`KSh${Math.round(displaySavings).toLocaleString()}`}
          additionalContent={
